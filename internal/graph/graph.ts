...
export class Graph {
    ...
    getTasksByLevel(): { [level: number]: Task[] } {
        ...
        breadthFirstWithDepth(this.taskObjects(this.startTasks), t => this.taskObjects(t.dependents), t => this.taskObjects(t.dependencies), (t, level) => {
    ...
    private findStartTasks(endTasks: string[]): string[] {
        ...
        breadthFirst(this.taskObjects(endTasks), t => this.taskObjects(t.dependencies), t => {
    ...
    private findEndTasks(startTasks: string[]): string[] {
        ...
        breadthFirst(this.taskObjects(startTasks), t => this.taskObjects(t.dependents), t => {
