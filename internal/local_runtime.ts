...
export class LocalRuntime implements Runtime {
    ...
    private _bootTasks: { pre: () => Promise<void>, post: () => Promise<void>, skipFlag: string }[] = [
        { pre: this.launchDockerServices, post: this.removeDockerServices, skipFlag: 'skip-services' }
    ];
